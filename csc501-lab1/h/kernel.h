...
/*Flags and Other variables to use*/
#define FLAGSET		1	//used for showing that process should not be executed till next epoch.
#define FLAGNOT		0	// used for showing that process should be executed.
#define EXHAUSTNOT	0
#define EXHAUSTSET	1	//process has exhausted and will not be rescheduled till new epoch.
#define EPOCHSET	0	//if this set then schedule the process, otherwise not.
#define EPOCHNOT	1



/*puts in the RANDOMSCHED and LINUXSCHED as 2*/
...
extern  int fhead,ftail,shead,stail,thead,ttail; /*first head and tail, for the 3 self defined queues*/
extern int lhead,ltail;
extern	int	preempt;
