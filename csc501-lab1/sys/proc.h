...
struct	pentry	{
	...
	int	pwaitret;
	int totalclockticks;
	/*Variables for third Algorithm:*/
	int flag;			/*specifies weather the  given process should be running or not, even though in queue.*/
	int ttr;			/*specifies the toatl time the process can run for.*/
	int counter;		/*the counter to calculate goodness and ttr for process*/
	int goodness;		/*specifies which process to run*/
	int exhaust;		/*Specifies the exaustion of process*/
	int clocktick;
};
